        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 5,),
              Text("Located at ${restaurant.city} with rate ${restaurant.rating}",style: Theme.of(context).textTheme.labelLarge,),
              SizedBox(height: 5,),
              Text(restaurant.description,style: TextStyle(fontSize: 12,color: Colors.black54),),
              SizedBox(height: 10),
              Text(
                "Foods:",
